...
const FOV_DIST     = 6;            // радиус видимости
const FADE_RATE    = 1 / 4;        // memoryAlpha до 0 за 4 сек
const REGEN_PERIOD = 1.0;          // интервал перегенерации сек
...
// ——————————————
//  Игрок и ввод (controls.js)
 // контролирует window.Input.dx, .dy
// ——————————————
let player = { x:0,y:0,angle:0 };
if(!window.Input) window.Input = { dx:0, dy:0 };

// ——————————————
//  Инициализация GameMap
// ——————————————
